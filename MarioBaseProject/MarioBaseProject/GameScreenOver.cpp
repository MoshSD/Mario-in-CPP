...
bool GameScreenOver::SetUpLevel()
{
	...
	if (!m_background_texture->LoadFromFile("Images/GameOverDefault.png"))
	{
	...
	if (!m_background_texture_scores->LoadFromFile("Images/GameOverScoresCursor.png"))
	{
		std::cout << "Failed to load background texture!" << std::endl;
		return false;
	}
	...
	if (!m_background_texture_menu->LoadFromFile("Images/GameOverMenuCursor.png"))
	{
		std::cout << "Failed to load background texture!" << std::endl;
		return false;
	}
